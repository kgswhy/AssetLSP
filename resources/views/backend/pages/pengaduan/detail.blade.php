            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($laporan->berkas_pendukung)
                                        ...
                                        <a href="{{ asset($laporan->berkas_pendukung) }}"
                                            download="{{ $laporan->berkas_pendukung }}" class="btn btn-primary"><i
                    ...
                    <div class="mt-4">
                        ...
                        @else
                            <a href="{{ route('tanggapan', Crypt::Encrypt($laporan->id)) }}"

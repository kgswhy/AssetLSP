...
@section('title', 'Detail Pengaduan | SMK Telkom Jakarta')
@section('content')
    <!---form -->
                        ...
                        <div
                            ...
                            @if (!$groupItem->pengaduan->berkas_pendukung)
                                <div class="flex justify-between items-center">
                                    <p
                                        class="px-3 py-1 mx-2 bg-gray-600 text-gray-100 text-sm font-bold rounded hover:bg-gray-500">
                            ...
                            <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">{{ $groupItem->tanggapan }}
                            </p>
                            <div class="block">
                                <a href="{{ url('site/cek-pengaduan') }}"
                                    class="inline-flex items-center w-full px-6 py-3 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out bg-transparent bg-red-600 border border-transparent md:px-3 md:w-auto md:rounded-md mt-5 lg:px-5 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-red-700">kembali</a>
                            </div>
                        </div>
                        <!-- card report -->
                    </div>
